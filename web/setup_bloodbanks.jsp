...
try { 
    ...
    for(String b : banks) { 
        ...
        rs.next();
        if(rs.getInt(1) == 0) {
            stmt.executeUpdate("INSERT INTO blood_banks (bank_name, email, phone, address_line1, city, pincode, latitude, longitude, status) VALUES ('" + parts[0] + "', '" + parts[1] + "', '" + parts[2] + "', '" + parts[3] + "', '" + parts[4] + "', '" + parts[5] + "', " + parts[6] + ", " + parts[7] + ", 'APPROVED')");
